          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 w-full">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link to="/privacy" onClick={scrollToTop} className="hover:text-indigo-400">Privacy Policy</Link></li>
                <li><Link to="/terms" onClick={scrollToTop} className="hover:text-indigo-400">Terms of Service</Link></li>
              </ul>
            </div>
            <div>
